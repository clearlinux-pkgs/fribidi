...
Source0  : https://github.com/fribidi/fribidi/releases/download/v1.0.16/fribidi-1.0.16.tar.xz
...
%prep
%setup -q -n fribidi-1.0.16
cd %{_builddir}/fribidi-1.0.16
pushd ..
cp -a fribidi-1.0.16 build32
popd
pushd ..
cp -a fribidi-1.0.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727296986

...
Source0  : https://github.com/fribidi/fribidi/releases/download/v1.0.11/fribidi-1.0.11.tar.xz
...
%prep
%setup -q -n fribidi-1.0.11
cd %{_builddir}/fribidi-1.0.11
pushd ..
cp -a fribidi-1.0.11 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632438422
...
cp %{_builddir}/fribidi-1.0.11/COPYING %{buildroot}/usr/share/package-licenses/fribidi/597bf5f9c0904bd6c48ac3a3527685818d11246d
pushd ../build32/
%make_install32

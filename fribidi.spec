...
Source0  : https://github.com/fribidi/fribidi/releases/download/v1.0.15/fribidi-1.0.15.tar.xz
...
%prep
%setup -q -n fribidi-1.0.15
cd %{_builddir}/fribidi-1.0.15
pushd ..
cp -a fribidi-1.0.15 build32
popd
pushd ..
cp -a fribidi-1.0.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717770814

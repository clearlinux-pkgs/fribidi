...
Source0  : https://github.com/fribidi/fribidi/releases/download/v1.0.14/fribidi-1.0.14.tar.xz
...
%prep
%setup -q -n fribidi-1.0.14
cd %{_builddir}/fribidi-1.0.14
pushd ..
cp -a fribidi-1.0.14 build32
popd
pushd ..
cp -a fribidi-1.0.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714056988
